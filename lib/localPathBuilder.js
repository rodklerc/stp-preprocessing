  ...
  for (var connectionId in this._allConnections) {
    ...
    if (finished && valid) {
      ...
      if (currentPath.length === 0) {
        ...
        // TODO the convexity check should be moved somewhere else so that we
        // can "capture" the output

        // We will now loop over the constructed path to check if we moved
        // to another cluster. We will use this to determine if a cluster is
        // convex or not.
